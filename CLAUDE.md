...
Vim snippet engine written in Python. Plugin code lives in `pythonx/UltiSnips/`, docs in `doc/UltiSnips.txt`.
...
Every new feature or bug fix needs a test. Tests are integration tests that run Vim inside tmux.
...
CI uses Docker across Vim 9.0/9.1/git and Python 3.10-3.13 (`.github/workflows/main.yml`).
